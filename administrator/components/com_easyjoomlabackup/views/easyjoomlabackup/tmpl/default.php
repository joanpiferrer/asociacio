...
// TODO
// Use JHtml::tooltipText(...) instead of JText::_(...) for further releases
// JText::_(...) is used here to support Joomla! version prior to 3.1.2!
?>
    ...
    <div id="j-main-container">
        <div id="filter-bar" class="btn-toolbar">
            <div class="filter-search btn-group pull-left">
                ...
                <input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('JSEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->_state->get('filter.search')); ?>" class="hasTooltip" title="<?php echo JText::_('JSEARCH_FILTER'); ?>" />
            </div>
                    ...
                    <td class="center" colspan="8">
                        <p>
                            <?php if(class_exists('ZipArchive')) : ?>
                                <span class="text-success"><?php echo JText::_('COM_EASYJOOMLABACKUP_ZIPARCHIVE_ACTIVATED'); ?> <span class="icon-easyjoomlabackup-success"></span></span>
                            <?php else : ?>
                                <span class="text-error"><?php echo JText::_('COM_EASYJOOMLABACKUP_ZIPARCHIVE_DEACTIVATED'); ?> <span class="icon-easyjoomlabackup-error"></span></span>
                            <?php endif; ?>
                        </p>
                        <p>
                            <?php if($this->db_type == 'mysqli') : ?>
                                <span class="text-success"><?php echo JText::_('COM_EASYJOOMLABACKUP_DBTYPE_MYSQLI'); ?> <span class="icon-easyjoomlabackup-success"></span></span>
                            <?php else : ?>
                                <span class="text-error"><?php echo JText::_('COM_EASYJOOMLABACKUP_DBTYPE_NOT_MYSQLI'); ?> <span class="icon-easyjoomlabackup-error"></span></span>
                            <?php endif; ?>
                        </p>
                    </td>
                </tr>
